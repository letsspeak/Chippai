...
{
  NSLog(@"_curData(String) = %@", [[NSString alloc] initWithData:curData encoding:NSUTF8StringEncoding]);
...
//  NSLog(@"outputBuffer(NSString) = %@", [[NSString alloc] initWithData:_outputBuffer encoding:NSUTF8StringEncoding]);
